...
<html>
  <head>
    ...
    <link href="resources/files/client/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="resources/files/client/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_default heading_1">
        <img id="u0_img" class="img " src="resources/images/client/u0.png"/>
        <!-- Unnamed () -->
        <div id="u1" class="text">
          <p><span>Add Client</span></p>
        </div>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u2" class="ax_default label">
        <img id="u2_img" class="img " src="resources/images/client/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u4" class="ax_default label">
        <img id="u4_img" class="img " src="resources/images/client/u4.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u6" class="ax_default label">
        <img id="u6_img" class="img " src="resources/images/client/u6.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u8" class="ax_default label">
        <img id="u8_img" class="img " src="resources/images/client/u8.png"/>
        <!-- Unnamed () -->
        <div id="u9" class="text">
          <p><span>Client Id:</span></p>
        </div>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u10" class="ax_default icon">
        <img id="u10_img" class="img " src="resources/images/client/u10.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u12" class="ax_default paragraph1" data-label="Text">
        <img id="u12_img" class="img " src="resources/images/client/text_u12.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Header 1 (Rectangle) -->
      <div id="u14" class="ax_default paragraph1" data-label="Header 1">
        <img id="u14_img" class="img " src="resources/images/client/header_1_u14.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Image (Image) -->
      <div id="u16" class="ax_default image" data-label="Image">
        <img id="u16_img" class="img " src="resources/images/client/image_u16.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u18" class="ax_default paragraph1" data-label="Text">
        <img id="u18_img" class="img " src="resources/images/client/text_u18.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u20" class="ax_default paragraph1" data-label="Text">
        <img id="u20_img" class="img " src="resources/images/client/text_u18.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u22" class="ax_default paragraph1" data-label="Text">
        <img id="u22_img" class="img " src="resources/images/client/text_u18.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u24" class="ax_default">
        <img id="u24_menu" class="img " src="resources/images/client/u24_menu.png" alt="u24_menu"/>
        ...
        <div id="u25" class="ax_default">
          ...
          <div id="u26" class="ax_default menu_item">
            <img id="u26_img" class="img " src="resources/images/client/u26.png"/>
            <!-- Unnamed () -->
          ...
          <div id="u28" class="ax_default menu_item">
            <img id="u28_img" class="img " src="resources/images/client/u28.png"/>
            <!-- Unnamed () -->
      ...
      <div id="u31" class="ax_default text_field1">
        <input id="clientid" type="text" value=""/>
      </div>

      <!-- project-id (Text Field) -->
      <div id="u32" class="ax_default text_field1">
        <input id="projectid" type="text" value=""/>
      </div>

      <!-- client-name (Text Field) -->
      <div id="u33" class="ax_default text_field1">
        <input id="clientname" type="text" value=""/>
      </div>

      <!-- Unnamed (Rectangle) -->
      <div id="u34" class="ax_default label">
        <img id="u34_img" class="img " src="resources/images/client/u34.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u36" class="ax_default text_field1">
        <input id="projectname" type="text" value=""/>
      </div>

      <!-- Description (Text Field) -->
      <div id="u37" class="ax_default text_field1">
        <input id="description" type="text" value=""/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u38" class="ax_default icon">
        <img id="u38_img" class="img " src="resources/images/client/u38.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u40" class="ax_default label">
        <img id="u40_img" class="img " src="resources/images/client/u34.png"/>
        <!-- Unnamed () -->
      ...
      <!-- e-mail (Text Field) -->
      <div id="u42" class="ax_default text_field1">
    ...
    <script>
			...
			$('#submit').click(function() {
				...
				$.ajax({
					...
					url : "http://localhost:8080/Spring4Swagger/addclient",
